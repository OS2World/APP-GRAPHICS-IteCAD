/****************************************************************************
** Meta object code from reading C++ file 'widget_zoom.h'
**
** Created: Sun Dec 18 11:14:00 2011
...
#error "The header file 'widget_zoom.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_Zoom[] = {
    "Zoom\0\0indice\0zoom_change(int)\0"
};

const QMetaObject Zoom::staticMetaObject = {
    { &QComboBox::staticMetaObject, qt_meta_stringdata_Zoom,
      qt_meta_data_Zoom, 0 }
};
...
int Zoom::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: zoom_change((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
